...
enum ParameterType {
  ParameterType_INT32 = 0,
  ParameterType_UINT32 = 1,
  ParameterType_FLOAT32 = 2,
  ParameterType_INT32_2 = 3,
  ParameterType_MIN = ParameterType_INT32,
  ParameterType_MAX = ParameterType_INT32_2
};

inline const ParameterType (&EnumValuesParameterType())[4] {
  static const ParameterType values[] = {
    ParameterType_INT32,
    ParameterType_UINT32,
    ParameterType_FLOAT32,
    ParameterType_INT32_2
  };
  return values;
}
...
inline const char *EnumNameParameterType(ParameterType e) {
  if (flatbuffers::IsOutRange(e, ParameterType_INT32, ParameterType_INT32_2)) return "";
...
inline const char *EnumNameDataType(DataType e) {
  if (flatbuffers::IsOutRange(e, DataType_UNKNOWN, DataType_INT16)) return "";
  const size_t index = static_cast<size_t>(e);
...
enum DataVariant {
  DataVariant_NONE = 0,
  DataVariant_DataInt32 = 1,
  DataVariant_DataFloat = 2,
  DataVariant_DataUint32 = 3,
  DataVariant_MIN = DataVariant_NONE,
  DataVariant_MAX = DataVariant_DataUint32
};

inline const DataVariant (&EnumValuesDataVariant())[4] {
  static const DataVariant values[] = {
    DataVariant_NONE,
    DataVariant_DataInt32,
    DataVariant_DataFloat,
    DataVariant_DataUint32
  };
  return values;
}
...
inline const char *EnumNameDataVariant(DataVariant e) {
  if (flatbuffers::IsOutRange(e, DataVariant_NONE, DataVariant_DataUint32)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesDataVariant()[index];
}

template<typename T> struct DataVariantTraits {
  static const DataVariant enum_value = DataVariant_NONE;
};

template<> struct DataVariantTraits<tflite::gpu::gl::data::DataInt32> {
  static const DataVariant enum_value = DataVariant_DataInt32;
};

template<> struct DataVariantTraits<tflite::gpu::gl::data::DataFloat> {
  static const DataVariant enum_value = DataVariant_DataFloat;
};

template<> struct DataVariantTraits<tflite::gpu::gl::data::DataUint32> {
  static const DataVariant enum_value = DataVariant_DataUint32;
};
...
enum AccessType {
  AccessType_READ = 0,
  AccessType_WRITE = 1,
  AccessType_READ_WRITE = 2,
  AccessType_MIN = AccessType_READ,
  AccessType_MAX = AccessType_READ_WRITE
};
...
inline const char *EnumNameAccessType(AccessType e) {
  if (flatbuffers::IsOutRange(e, AccessType_READ, AccessType_READ_WRITE)) return "";
  const size_t index = static_cast<size_t>(e);
...
enum ObjectType {
  ...
  ObjectType_BUFFER = 1,
  ObjectType_TEXTURE = 2,
  ObjectType_MIN = ObjectType_UNKNOWN,
  ObjectType_MAX = ObjectType_TEXTURE
};
...
inline const char *EnumNameObjectType(ObjectType e) {
  if (flatbuffers::IsOutRange(e, ObjectType_UNKNOWN, ObjectType_TEXTURE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesObjectType()[index];
}

enum ObjectVariant {
  ObjectVariant_NONE = 0,
  ObjectVariant_ObjectData = 1,
  ObjectVariant_ObjectRef = 2,
  ObjectVariant_MIN = ObjectVariant_NONE,
  ObjectVariant_MAX = ObjectVariant_ObjectRef
};

inline const ObjectVariant (&EnumValuesObjectVariant())[3] {
  static const ObjectVariant values[] = {
    ObjectVariant_NONE,
    ObjectVariant_ObjectData,
    ObjectVariant_ObjectRef
  };
  return values;
}
...
inline const char *EnumNameObjectVariant(ObjectVariant e) {
  if (flatbuffers::IsOutRange(e, ObjectVariant_NONE, ObjectVariant_ObjectRef)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesObjectVariant()[index];
}

template<typename T> struct ObjectVariantTraits {
  static const ObjectVariant enum_value = ObjectVariant_NONE;
};

template<> struct ObjectVariantTraits<tflite::gpu::gl::data::ObjectData> {
  static const ObjectVariant enum_value = ObjectVariant_ObjectData;
};

template<> struct ObjectVariantTraits<tflite::gpu::gl::data::ObjectRef> {
  static const ObjectVariant enum_value = ObjectVariant_ObjectRef;
};
...
enum ObjectSize {
  ...
  ObjectSize_Uint2 = 2,
  ObjectSize_Uint3 = 3,
  ObjectSize_MIN = ObjectSize_NONE,
  ObjectSize_MAX = ObjectSize_Uint3
};
...
inline const char *EnumNameObjectSize(ObjectSize e) {
  if (flatbuffers::IsOutRange(e, ObjectSize_NONE, ObjectSize_Uint3)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesObjectSize()[index];
}

template<typename T> struct ObjectSizeTraits {
  static const ObjectSize enum_value = ObjectSize_NONE;
};

template<> struct ObjectSizeTraits<tflite::gpu::gl::data::Uint1> {
  static const ObjectSize enum_value = ObjectSize_Uint1;
};

template<> struct ObjectSizeTraits<tflite::gpu::gl::data::Uint2> {
  static const ObjectSize enum_value = ObjectSize_Uint2;
};

template<> struct ObjectSizeTraits<tflite::gpu::gl::data::Uint3> {
  static const ObjectSize enum_value = ObjectSize_Uint3;
};
...
struct UniformParameter FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const tflite::gpu::gl::data::DataInt32 *data_as_DataInt32() const {
    return data_type() == tflite::gpu::gl::data::DataVariant_DataInt32 ? static_cast<const tflite::gpu::gl::data::DataInt32 *>(data()) : nullptr;
  }
  const tflite::gpu::gl::data::DataFloat *data_as_DataFloat() const {
    return data_type() == tflite::gpu::gl::data::DataVariant_DataFloat ? static_cast<const tflite::gpu::gl::data::DataFloat *>(data()) : nullptr;
  }
  const tflite::gpu::gl::data::DataUint32 *data_as_DataUint32() const {
    return data_type() == tflite::gpu::gl::data::DataVariant_DataUint32 ? static_cast<const tflite::gpu::gl::data::DataUint32 *>(data()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
inline flatbuffers::Offset<UniformParameter> CreateUniformParameter(
    ...
    tflite::gpu::gl::data::ParameterType type = tflite::gpu::gl::data::ParameterType_INT32,
    tflite::gpu::gl::data::DataVariant data_type = tflite::gpu::gl::data::DataVariant_NONE,
...
struct Object FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const tflite::gpu::gl::data::Uint1 *size_as_Uint1() const {
    return size_type() == tflite::gpu::gl::data::ObjectSize_Uint1 ? static_cast<const tflite::gpu::gl::data::Uint1 *>(size()) : nullptr;
  }
  const tflite::gpu::gl::data::Uint2 *size_as_Uint2() const {
    return size_type() == tflite::gpu::gl::data::ObjectSize_Uint2 ? static_cast<const tflite::gpu::gl::data::Uint2 *>(size()) : nullptr;
  }
  const tflite::gpu::gl::data::Uint3 *size_as_Uint3() const {
    return size_type() == tflite::gpu::gl::data::ObjectSize_Uint3 ? static_cast<const tflite::gpu::gl::data::Uint3 *>(size()) : nullptr;
  }
  ...
  const tflite::gpu::gl::data::ObjectData *object_as_ObjectData() const {
    return object_type() == tflite::gpu::gl::data::ObjectVariant_ObjectData ? static_cast<const tflite::gpu::gl::data::ObjectData *>(object()) : nullptr;
  }
  const tflite::gpu::gl::data::ObjectRef *object_as_ObjectRef() const {
    return object_type() == tflite::gpu::gl::data::ObjectVariant_ObjectRef ? static_cast<const tflite::gpu::gl::data::ObjectRef *>(object()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
inline flatbuffers::Offset<Object> CreateObject(
    flatbuffers::FlatBufferBuilder &_fbb,
    tflite::gpu::gl::data::AccessType access = tflite::gpu::gl::data::AccessType_READ,
    uint32_t binding = 0,
    tflite::gpu::gl::data::DataType data_type = tflite::gpu::gl::data::DataType_UNKNOWN,
    tflite::gpu::gl::data::ObjectType type = tflite::gpu::gl::data::ObjectType_UNKNOWN,
    tflite::gpu::gl::data::ObjectSize size_type = tflite::gpu::gl::data::ObjectSize_NONE,
    flatbuffers::Offset<void> size = 0,
    tflite::gpu::gl::data::ObjectVariant object_type = tflite::gpu::gl::data::ObjectVariant_NONE,
...
inline bool VerifyObjectVariant(flatbuffers::Verifier &verifier, const void *obj, ObjectVariant type) {
  switch (type) {
    case ObjectVariant_NONE: {
      return true;
    }
    case ObjectVariant_ObjectData: {
      auto ptr = reinterpret_cast<const tflite::gpu::gl::data::ObjectData *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ObjectVariant_ObjectRef: {
